...
int main(int argc, char *argv[])//without intensity nomalization
{
	...
	string strFileNameVsls ="F:/Coronary_0/trainningdataZXHCAEDMP/Occlusion/nii/MPREF_OCC_DI4_Gau_vesselness.nii.gz";
	string strFileNameRaw ="F:/Coronary_0/trainningdataZXHCAEDMP/Occlusion/nii/MPREF_OCC_DI4_Gau.nii.gz";
	char *chResoRawName ="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset00/Resmol4_image04_refgau4.nii.gz";
	char *chResoVslsName ="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset00/Remoeb4_image04_vesselness_refgau4.nii.gz";
	//char *chAtlsMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas00_mean_std.txt";
	char *chUnseenMeanStdDevFileName="F:/Coronary_0/meanstd/atlas04_mean_std.txt";
	char *chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image00_00mline_v0_inten.txt";
	//**command
	//image data,vesselness data
	/*string strFileNameVsls = "F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung/mol_image08_vesselness.nii";
	string strFileNameRaw = "F:/Coronary_0/Coronary_Niessen/ProcessByLL/testing/dataset08/image08.nii";	
	char *chResoRawName ="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset00/vessel0/Res_image08.nii";
	char *chResoVslsName ="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset00/vessel0/Remol_image08_vesselness.nii";
	char *chAtlsMeanStdDevFileName = "F:/Coronary_0/meanstd/atlas00_mean_std.txt";
	char *chUnseenMeanStdDevFileName = "F:/Coronary_0/meanstd/atlas08_mean_std.txt";
	char *chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image00_00mline_v0_inten.txt";*/
	...
	//string strFileNameRaw = "F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung/mol_image02.nii";
	//char *chResultPath = "F:/Coronary_0/miiMinPathModelApp_results/mod00_to_unseen02_results_physnoimgres/ori_vessel0/Thetalower30/NearestTangentPlane/WithMask/PotentialPlus/newepsilon_0.01";
	//char *chResultPath = "F:/Coronary_0/MultiResolution_results/DataMaskOutLung/WithWindoingVesselness200/SetOriIntensity/00to01ResoImage";
	//intensity settings data
	//string strFileNameAtls = "F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung/mol_image00.nii";
	//char *chFileNameAtlsCA = "F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset00/vessel2/reference.vtk";
	/*char *chAtlsMeanStdDevFileName = "F:/Coronary_0/meanstd/atlas00_mean_std.txt";
	char *chUnseenMeanStdDevFileName = "F:/Coronary_0/meanstd/atlas00_to_atlas02_mean_std.txt";
	string strFileNameAtls = "F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung/mol_image00.nii";
	char *chFileNameAtlsCA = "F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset00/vessel0/reference.vtk";*/
	...
	const short *sImData = imgReadRaw.GetImageData();
	// get the image spacing
	float fNewImgSpacing[]={4,4,4,1};//Add by JDQ
	float fOldImgSpacing[]={1,1,1,1};
	float fImgExtend[ImageDimensionMax]={1,1,1,1};
	float div[ImageDimensionMax] = {1,1,1,1};
