...
bool ReadMeanStdDevFromTxt(char *chFileName, double &fMean, double &fStdDev)
{
	...
	if(!iFileIn)
	{
		cout << "Unable to open meanstd txt-file: " << endl;
...
bool ReadPointTxt(char *filename,vector< miiCNode<double, float> > &cl)
{
	...
	if(!iFileIn)
	{
		cout << "Unable to open ref point txt-file: " << endl;
		cout << filename << endl;
		return false; //exit(1); // terminate with error
	}
	string strLine;
...
bool ReadPointTxt_RefP(char *filename,vector< miiCNode<double, float> > &cl)
{
    string strNum;
	int nStart = 0, nEnd = 0;
	miiCNode<double, float> strctTempPoint;
	...
	if(!iFileIn)
	{
		cout << "Unable to open point txt-file: " << endl;
		cout << filename << endl;
		return false; //exit(1); // terminate with error
	}
	string strLine;
...
int nMaxSgmtNum=0;
string strLorH="";
string strFileNameVslsx="";
string strFileNameVslsy="";
string strFileNameVslsz="";
char *chREFPointFileName="";
//
if( argc == 16 )
{
	...
	strFileNameVslsx=string(argv[12]);
	strFileNameVslsy=string(argv[13]);
	strFileNameVslsz=string(argv[14]);
	chREFPointFileName=argv[15];
...
else if( argc == 17 )
{
	...
	strFileNameVslsx=string(argv[13]);
	strFileNameVslsy=string(argv[14]);
	strFileNameVslsz=string(argv[15]);
	chREFPointFileName=argv[16];
}
else
{
	std::cerr << "Usage: " << std::endl;
	std::cerr << "zxhcaeDMP_1.1_MLLMN	imageRaw (.nii)  vesselness	(.nii)	atlas_vesselx	results	atlas_vessel	\
				 detected-ostial atlas_mean	unseen_mean	ModelPointsIntensity	mask segment_num  H" << std::endl;
	std::cerr << "  Or zxhcaeDMP_1.1_MLLMN	imageRaw (.nii)  vesselness	(.nii)	atlas_vesselx	results	atlas_vessel	\
...
//strLorH="H";
//////////////////
//strFileNameRaw ="F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung/mol_image00.nii.gz";
//strFileNameVsls= "F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung/moeb_image00_vesselness.nii.gz";//"F:/Coronary_0/Coronary_Niessen/CoronaryCMBImg/CMB_image13_v0_vesselness2.nii.gz";
//chModelMapCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v0.vtk";
//chResultPath="F:/Coronary_0/trainningdataZXHCAEDMP/DirHighResultsDFM_new_PC/mod01_to_unseen00_results/meanimg01v0model";
//chAtlasCAFileName ="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v0.vtk";
//chREFFileName ="F:/Coronary_0/Coronary_Niessen/ProcessByLL/training/dataset00/rightostium_world.txt";
//chAtlsMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas01_mean_std.txt";
//chUnseenMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas00_mean_std.txt";
//chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image01_01mline_v0_inten.txt";
//nMaxSgmtNum =30;
//strLorH="DH";
//strFileNameVslsx="F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung_U/vesselness_u1/mol_image00_vesselness_new_x.nii.gz";
//strFileNameVslsy="F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung_U/vesselness_u1/mol_image00_vesselness_new_y.nii.gz";
//strFileNameVslsz="F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung_U/vesselness_u1/mol_image00_vesselness_new_z.nii.gz";
//
//strFileNameRaw ="F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung/mol_image00.nii.gz";
//strFileNameVsls= "F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung/moeb_image00_vesselness.nii.gz";//"F:/Coronary_0/Coronary_Niessen/CoronaryCMBImg/CMB_image13_v0_vesselness2.nii.gz";
//chModelMapCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v1.vtk";
//chResultPath="F:/Coronary_0/trainningdataZXHCAEDMP/DirHighResultsDFM_new_PC/mod01_to_unseen00_results/meanimg01v1model";
//chAtlasCAFileName ="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v1.vtk";
//chREFFileName ="F:/Coronary_0/Coronary_Niessen/ProcessByLL/training/dataset00/leftostium_world.txt";
//chAtlsMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas01_mean_std.txt";
//chUnseenMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas00_mean_std.txt";
//chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image01_01mline_v1_inten.txt";
//nMaxSgmtNum =30;
//strLorH="DH";
//strFileNameVslsx="F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung_U/vesselness_u1/mol_image00_vesselness_new_x.nii.gz";
//strFileNameVslsy="F:/Coronary_0/Coronary_Niessen/CoronaryMasks/DataMaskOutLung_U/vesselness_u1/mol_image00_vesselness_new_y.nii.gz";
...
//
//
//strFileNameRaw ="F:/Coronary_0/trainningdataZXHCAEDMP/Occlusion/synrefgz/MPREF_DI4_gau.nii.gz";
//strFileNameVsls= "F:/Coronary_0/trainningdataZXHCAEDMP/Occlusion/synrefgz/MPREF_DI4_gau_vesselness_new.nii.gz";//"F:/Coronary_0/Coronary_Niessen/CoronaryCMBImg/CMB_image13_v0_vesselness2.nii.gz";
//chModelMapCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image05_meancenterline_v3.vtk";
//chResultPath="F:/Coronary_0/trainningdataZXHCAEDMP/Occlusion/DFMResults_VSLS/mod05_to_unseen04_results/meanimg05v3model";
//chAtlasCAFileName ="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image05_meancenterline_v3.vtk";
//chREFFileName ="F:/Coronary_0/Coronary_Niessen/ProcessByLL/training/dataset04/leftostium_world.txt";
//chAtlsMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas05_mean_std.txt";
//chUnseenMeanStdDevFileName ="F:/Coronary_0/meanstd/atlas04_mean_std.txt";
//chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image05_05mline_v3_inten.txt";
//nMaxSgmtNum =30;
//strLorH="DH";
//strFileNameVslsx="F:/Coronary_0/trainningdataZXHCAEDMP/Occlusion/synrefgz/MPREF_DI4_gau_vesselness_x1_new.nii.gz";
//strFileNameVslsy="F:/Coronary_0/trainningdataZXHCAEDMP/Occlusion/synrefgz/MPREF_DI4_gau_vesselness_y1_new.nii.gz";
//strFileNameVslsz="F:/Coronary_0/trainningdataZXHCAEDMP/Occlusion/synrefgz/MPREF_DI4_gau_vesselness_z1_new.nii.gz";
//
...
//strFileNameRaw="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/mol_image/mol_new_image00.nii.gz" ;
//strFileNameVsls="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_vesselness/moeb_image_00_new_vesselness.nii.gz" ;
//chModelMapCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v0.vtk" ;
//chResultPath="F:/Coronary_0/ZXHJDQCAEDMP/DHResDFM/mod01_to_unseen00_results/meanimg01v0model" ;
//chAtlasCAFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_2014_01_17/image01_meancenterline_v0.vtk" ;
//chREFFileName="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/training/dataset00/rightostium_world.txt" ;
//chAtlsMeanStdDevFileName="F:/Coronary_0/meanstd/atlas01_mean_std.txt" ;
//chUnseenMeanStdDevFileName="F:/Coronary_0/meanstd/atlas00_mean_std.txt" ;
//chMolPointsIntensityFileName="F:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image01_01mline_v0_inten.txt" ;
//nMaxSgmtNum=30 ;
//strLorH="DH";
//strFileNameVslsx="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_u1_vesselness/mol_image00_new_vesselness_x1.nii.gz" ;
//strFileNameVslsy="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_u1_vesselness/mol_image00_new_vesselness_y1.nii.gz" ;
//strFileNameVslsz="F:/Coronary_0/Coronary_Niessen/ProcessByJDQ/moeb_u1_vesselness/mol_image00_new_vesselness_z1.nii.gz";

//rebuttal
//strFileNameRaw ="I:/fromJDQ/DFMcae_micc2017/data/ProcessByJDQ/mol_image/mol_new_image01.nii.gz";
//strFileNameVsls= "I:/fromJDQ/DFMcae_micc2017/data/ProcessByJDQ/moeb_vesselness/moeb_image_01_new_vesselness.nii.gz";//"F:/Coronary_0/Coronary_Niessen/CoronaryCMBImg/CMB_image13_v0_vesselness2.nii.gz";
//chModelMapCAFileName="I:/fromJDQ/DFMcae_micc2017/data/mean_centerline_2014_01_17/image00_meancenterline_v0.vtk";
//chResultPath="I:/fromJDQ/rebuttal_media18/rebuttal/Exp/Res_onlyVV/mod00_to_unseen01_results/meanimg00v0model";
//chAtlasCAFileName ="I:/fromJDQ/DFMcae_micc2017/data/mean_centerline_2014_01_17/image00_meancenterline_v0.vtk ";
//chREFFileName ="I:/fromJDQ/DFMcae_micc2017/data/ProcessByJDQ/training/dataset01/rightostium_world.txt";
//
//chAtlsMeanStdDevFileName ="I:/fromJDQ/DFMcae_micc2017/data/meanstd/atlas00_mean_std.txt";
//chUnseenMeanStdDevFileName ="I:/fromJDQ/DFMcae_micc2017/data/meanstd/atlas01_mean_std.txt ";
//chMolPointsIntensityFileName="I:/Coronary_0/Coronary_Niessen/mean_centerline_intensity/image00_00mline_v0_inten.txt";
//nMaxSgmtNum =30;
//strLorH="DH";
//strFileNameVslsx="I:/fromJDQ/DFMcae_micc2017/data/ProcessByJDQ/moeb_u1_vesselness/mol_image01_new_vesselness_x1.nii.gz";
//strFileNameVslsy="I:/fromJDQ/DFMcae_micc2017/data/ProcessByJDQ/moeb_u1_vesselness/mol_image01_new_vesselness_y1.nii.gz";
//strFileNameVslsz="I:/fromJDQ/DFMcae_micc2017/data/ProcessByJDQ/moeb_u1_vesselness/mol_image01_new_vesselness_z1.nii.gz";
//chREFPointFileName ="I:/fromJDQ/DFMcae_micc2017/data/ProcessByJDQ/training/dataset00/vessel0/pointE.txt";
//rebuttal
...
//read model points intensity
	...
	//read a "nifti" file
	zxhImageDataT<short> imgReadVsls, imgReadRaw,imgReadLineMask,imgReadVslsx,imgReadVslsy,imgReadVslsz; //Change by JDQ
	...
	{
		std::cerr << "Vesselnessx image(nifti-file) is not found!"; 
		return -1;
	}
	if( zxh::OpenImage( &imgReadVslsy, strFileNameVslsy ) == false )
	{
		std::cerr << "Vesselnessy image(nifti-file) is not found!"; 
		return -1;
	}
	if( zxh::OpenImage( &imgReadVslsz, strFileNameVslsz ) == false )
	{
		std::cerr << "Vesselnessz image(nifti-file) is not found!"; 
		return -1;
	}
int MasknoneZeroNUM=0;
	...
	double *dWinVslsx=new double[nImWX * nImWY * nImWZ];
	double *dWinVslsy=new double[nImWX * nImWY * nImWZ];
	double *dWinVslsz=new double[nImWX * nImWY * nImWZ];
	double dMaxWinVslsxyz=512.0;
	...
	//for the synthesis data
	/*for (int i = 0; i < nImWX * nImWY * nImWZ; i++)
	{
		sWinVsls[i] = sVslsData[i];
		sWinImg[i] = sImData[i];
	}*/
	//recover the original vector values
	for (int i = 0; i < nImWX * nImWY * nImWZ; i++)
	{
		if(imgReadVslsx.GetImageData(i)==0)
		{
			dWinVslsx[i]=0;
		}
		else
		{
           dWinVslsx[i]=imgReadVslsx.GetImageData(i)/dMaxWinVslsxyz;
		}
		if(imgReadVslsy.GetImageData(i)==0)
		{
			dWinVslsy[i]=0;
		}
		else
		{
          dWinVslsy[i]=imgReadVslsy.GetImageData(i)/dMaxWinVslsxyz;
		}
		if(imgReadVslsz.GetImageData(i)==0)
		{
			dWinVslsz[i]=0;
		}
		else
		{
          dWinVslsz[i]=imgReadVslsz.GetImageData(i)/dMaxWinVslsxyz;
		}
		 
		 
	}	
	
	int si=imgReadVslsz.GetNumberOfPixels();
	vector< miiCNode<double, float> > UVectorPoint;
	{
		if (UVectorPoint.size()!=0)
		{
			UVectorPoint.clear();
		}
		miiCNode<double, float> TmpP;
		...
		for (int i = 0; i < nImWX * nImWY * nImWZ; i++)
		{
			...
			TmpP.z=dWinVslsz[i];
			TmpP.val=0;
			UVectorPoint.push_back(TmpP);
		}
	}
	int ix=287;int iy=249;int iz=241;
	float x=UVectorPoint[iz* nImWY * nImWX + iy* nImWX + ix].x;
	float y=UVectorPoint[iz* nImWY * nImWX + iy* nImWX + ix].y;
	float z=UVectorPoint[iz* nImWY * nImWX + iy* nImWX + ix].z;
	...
	/*double dx=dWinVslsx[192 * nImWY * nImWX + 146 * nImWX + 181];
	double dy=dWinVslsy[192 * nImWY * nImWX + 146 * nImWX + 181];
	double dz=dWinVslsz[192 * nImWY * nImWX + 146 * nImWX + 181];*/
...
// get end point of model
	...
	// get the end point of the vessel
	nVesselEndPoint[0] =-1*vREFEndPoints[0].x;
	nVesselEndPoint[1] =-1*vREFEndPoints[0].y;
	nVesselEndPoint[2] = vREFEndPoints[0].z;
	...
	int nLen0 = strlen(chResultPath) + strlen("/MMLine") +  strlen("0.vtk") + 1;//strlen:计数器
	char *chFileName0 = (char *)malloc(nLen0);//动态内存分配
	strcpy(chFileName0, chResultPath);
	strcat(chFileName0, "/MMLine");//将两个char连接
	strcat(chFileName0, "0.vtk");
	iMinPathModelCrct->WriteCA2VtkMML(chFileName0);
	free(chFileName0);
	...
	iMinPathModelCrct->ModifiedFastMarchingInit_OnlyVV(sWinImg, imgReadRaw.GetImageInfo(), \
	...
	{			
		...
		//for 10-16 testing
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DN(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DN_VVSel(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz; 11-21 code
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DN_VVSel_3S(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz

		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DN_VVSel_VSPSC(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz;vessel segment point selection condition;paper results
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DN_VVSel_VSPSC_DMP(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz;vessel segment point selection condition;paper results
		...
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DN_VVSel_VSPSC_BPD(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz;vessel segment point selection condition
		nItrNum =iMinPathModelCrct->DFM_revo_rebu_OnlyVV(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,nVesselEndPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz;vessel segment point selection condition
		

		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DNB(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz,chose best point from NB
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DNB_WORec(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz,chose best point from NB
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DNBCV(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz,chose best point from NB
		//nItrNum =iMinPathModelCrct->ModifiedFastMarchingEvolutiondontMoveModelwithFindMinPathPointCNewLL_DeaFM_DFMP(nMaxItrNum,nItrNumSum,sWinImg,imgReadRaw.GetImageInfo(),nStartPoint,MasknoneZeroNUM,imgReadLineMask,UVectorPoint);//Decrease the weigth of direction and intensity,u1.xyz,chose best point from NB
